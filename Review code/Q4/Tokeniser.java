...
public class Tokeniser {
    ...
    public Token next() {
        ...
        if (Character.isDigit(_buffer.charAt(0))) {
            return new Token(Token.Type.NUMBER, _buffer.substring(0, 1));
        }

        else if (MATH_OPERATIONS.contains(_buffer.charAt(0))) {
            return new Token(Token.Type.MATH_OPERATION, _buffer.substring(0, 1));
        }
        // END YOUR CODE
