...
public class Tokeniser {
    ...
    public Token next() {
        ...
        // START YOUR CODE
        if (_buffer.charAt(0) == '(') {
            return new Token(Token.Type.LEFT_BRACKET, _buffer.substring(0, 1));
        } else if (_buffer.charAt(0) == ')') {
            return new Token(Token.Type.RIGHT_BRACKET, _buffer.substring(0, 1));
        } else {
            return new Token(null, _buffer.substring(0, 1));
        }
        // END YOUR CODE
    }
